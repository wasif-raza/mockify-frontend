...
function IndexPage() {
  ...
  return (
    <div className="flex flex-col">
      <section className="container flex flex-col items-center justify-center py-32 text-center space-y-8">
      ...
      <section className="container py-32 flex justify-center">
        <div className="w-full max-w-3xl rounded-xl border border-border bg-card shadow-xl overflow-hidden font-mono text-sm">
          <div className="flex items-center justify-center relative px-4 py-3 border-b border-border bg-muted">
          ...
          <pre className="p-6 text-foreground overflow-x-auto">
            <code className="space-y-1 block">
              ...
              {'\n'}
              <span className="pl-12 text-primary">name:</span>{' '}
              <span className="text-foreground">fullName</span>
              {'\n'}
              <span className="pl-12 text-primary">online:</span>{' '}
              <span className="text-foreground">bool</span>
            </code>
          </pre>
        </div>
      </section>
...
function PricingCard({
  ...
  return (
    <div
      className={`rounded-xl border border-border p-8 shadow-sm space-y-6 ${
        featured
